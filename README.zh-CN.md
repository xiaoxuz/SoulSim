...
在线体验 Demo 站：[https://xiaoxuz.github.io/SoulSim/](https://xiaoxuz.github.io/SoulSim/)

Demo 站会在浏览器内回放一个内置的已完成世界，并模拟 API 响应和流式事件。它主要用于快速体验 SoulSim 的完整工作流，不需要后端、数据库或 LLM 服务。

Demo 操作录屏：[docs/assets/demo-replay.mp4](docs/assets/demo-replay.mp4)
...
| 步骤 | 说明 | 预览 |
| --- | --- | --- |
| 1. 输入种子 | 配置世界背景、模拟目标、Agent 数量和推演天数。 | <img src="docs/assets/step1.jpg" alt="Step 1 种子输入" width="220"> |
| 2. 构建世界 | 自动生成世界背景、Agent 档案、知识图谱和推演记录列表。 | <img src="docs/assets/step2.jpg" alt="Step 2 世界构建结果与推演记录列表" width="220"> |
| 3. 运行模拟 | 多 Agent 按天行动，通过流式日志、阶段状态和时间线观察演化。 | <img src="docs/assets/step3.jpg" alt="Step 3 多 Agent 推演日志" width="220"> |
| 4. 生成报告 | 生成包含叙事、目标评估、角色视角、指标、驱动因素和证据映射的结构化报告。 | <img src="docs/assets/step4.jpg" alt="Step 4 结构化报告" width="220"> |
| 5. 深度互动 | 基于当前 run，与单个角色、Report Agent 或多个 Agent 群聊继续追问。 | <img src="docs/assets/step5-1.jpg" alt="Step 5 角色与报告深度互动" width="160"> <img src="docs/assets/step5-2.jpg" alt="Step 5 多 Agent 群聊" width="160"> |
...
如果要在本地预览只依赖前端的 Demo 站，可开启 Demo 模式启动前端：
